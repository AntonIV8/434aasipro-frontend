...
moduleForModel('data-line-434aasipro-resource-spec-characteristic', 'Unit | Serializer | data-line-434aasipro-resource-spec-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-434aasipro-resource-spec-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
