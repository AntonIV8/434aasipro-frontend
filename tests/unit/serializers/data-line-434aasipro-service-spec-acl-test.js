...
moduleForModel('data-line-434aasipro-service-spec-acl', 'Unit | Serializer | data-line-434aasipro-service-spec-acl', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-434aasipro-service-spec-acl',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
