...
moduleForModel('data-line-434aasipro-characteristic-type', 'Unit | Serializer | data-line-434aasipro-characteristic-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-434aasipro-characteristic-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
