...
moduleForModel('data-line-434aasipro-service-usage-spec', 'Unit | Serializer | data-line-434aasipro-service-usage-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-434aasipro-service-usage-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
