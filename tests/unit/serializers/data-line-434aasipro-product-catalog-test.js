...
moduleForModel('data-line-434aasipro-product-catalog', 'Unit | Serializer | data-line-434aasipro-product-catalog', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-434aasipro-product-catalog',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
