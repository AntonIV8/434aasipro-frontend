...
moduleForModel('data-line-434aasipro-resource-common', 'Unit | Serializer | data-line-434aasipro-resource-common', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-434aasipro-resource-common',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
