...
moduleForModel('data-line-434aasipro-dictionary-value', 'Unit | Serializer | data-line-434aasipro-dictionary-value', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-434aasipro-dictionary-value',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
