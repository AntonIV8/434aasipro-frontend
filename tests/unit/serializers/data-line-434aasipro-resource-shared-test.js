...
moduleForModel('data-line-434aasipro-resource-shared', 'Unit | Serializer | data-line-434aasipro-resource-shared', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-434aasipro-resource-shared',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
